...
const (
	AuthService_CandidateSignup_FullMethodName          = "/auth.AuthService/CandidateSignup"
	AuthService_CandidateLogin_FullMethodName           = "/auth.AuthService/CandidateLogin"
	AuthService_CandidateVerifyEmail_FullMethodName     = "/auth.AuthService/CandidateVerifyEmail"
	AuthService_CandidateResendOtp_FullMethodName       = "/auth.AuthService/CandidateResendOtp"
	AuthService_CandidateForgotPassword_FullMethodName  = "/auth.AuthService/CandidateForgotPassword"
	AuthService_CandidateResetPassword_FullMethodName   = "/auth.AuthService/CandidateResetPassword"
	AuthService_CandidateGoogleLogin_FullMethodName     = "/auth.AuthService/CandidateGoogleLogin"
	AuthService_CandidateGoogleCallback_FullMethodName  = "/auth.AuthService/CandidateGoogleCallback"
	AuthService_CandidateChangePassword_FullMethodName  = "/auth.AuthService/CandidateChangePassword"
	AuthService_CandidateProfile_FullMethodName         = "/auth.AuthService/CandidateProfile"
	AuthService_CandidateProfileUpdate_FullMethodName   = "/auth.AuthService/CandidateProfileUpdate"
	AuthService_CandidateSkillsUpdate_FullMethodName    = "/auth.AuthService/CandidateSkillsUpdate"
	AuthService_CandidateEducationUpdate_FullMethodName = "/auth.AuthService/CandidateEducationUpdate"
	AuthService_CandidateUploadResume_FullMethodName    = "/auth.AuthService/CandidateUploadResume"
	AuthService_EmployerSignup_FullMethodName           = "/auth.AuthService/EmployerSignup"
	AuthService_EmployerLogin_FullMethodName            = "/auth.AuthService/EmployerLogin"
	AuthService_EmployerVerifyEmail_FullMethodName      = "/auth.AuthService/EmployerVerifyEmail"
	AuthService_EmployerResendOtp_FullMethodName        = "/auth.AuthService/EmployerResendOtp"
	AuthService_EmployerForgotPassword_FullMethodName   = "/auth.AuthService/EmployerForgotPassword"
	AuthService_EmployerResetPassword_FullMethodName    = "/auth.AuthService/EmployerResetPassword"
	AuthService_EmployerGoogleLogin_FullMethodName      = "/auth.AuthService/EmployerGoogleLogin"
	AuthService_EmployerGoogleCallback_FullMethodName   = "/auth.AuthService/EmployerGoogleCallback"
	AuthService_EmployerChangePassword_FullMethodName   = "/auth.AuthService/EmployerChangePassword"
	AuthService_EmployerProfile_FullMethodName          = "/auth.AuthService/EmployerProfile"
	AuthService_EmployerProfileUpdate_FullMethodName    = "/auth.AuthService/EmployerProfileUpdate"
)
...
type AuthServiceClient interface {
	...
	CandidateSignup(ctx context.Context, in *CandidateSignupRequest, opts ...grpc.CallOption) (*GenericResponse, error)
	CandidateLogin(ctx context.Context, in *CandidateLoginRequest, opts ...grpc.CallOption) (*TokenResponse, error)
	CandidateVerifyEmail(ctx context.Context, in *CandidateVerifyEmailRequest, opts ...grpc.CallOption) (*TokenResponse, error)
	...
	CandidateGoogleLogin(ctx context.Context, in *GoogleLoginRequest, opts ...grpc.CallOption) (*GenericResponse, error)
	CandidateGoogleCallback(ctx context.Context, in *GoogleCallbackRequest, opts ...grpc.CallOption) (*TokenResponse, error)
	...
	CandidateUploadResume(ctx context.Context, in *UploadResumeRequest, opts ...grpc.CallOption) (*UploadResumeResponse, error)
	// --- Employer Public Routes ---
	EmployerSignup(ctx context.Context, in *EmployerSignupRequest, opts ...grpc.CallOption) (*GenericResponse, error)
	EmployerLogin(ctx context.Context, in *EmployerLoginRequest, opts ...grpc.CallOption) (*TokenResponse, error)
	EmployerVerifyEmail(ctx context.Context, in *EmployerVerifyEmailRequest, opts ...grpc.CallOption) (*TokenResponse, error)
	...
	EmployerGoogleLogin(ctx context.Context, in *GoogleLoginRequest, opts ...grpc.CallOption) (*GenericResponse, error)
	EmployerGoogleCallback(ctx context.Context, in *GoogleCallbackRequest, opts ...grpc.CallOption) (*TokenResponse, error)
...
func (c *authServiceClient) CandidateSignup(ctx context.Context, in *CandidateSignupRequest, opts ...grpc.CallOption) (*GenericResponse, error) {
...
func (c *authServiceClient) CandidateLogin(ctx context.Context, in *CandidateLoginRequest, opts ...grpc.CallOption) (*TokenResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *authServiceClient) CandidateVerifyEmail(ctx context.Context, in *CandidateVerifyEmailRequest, opts ...grpc.CallOption) (*TokenResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TokenResponse)
...
func (c *authServiceClient) CandidateGoogleLogin(ctx context.Context, in *GoogleLoginRequest, opts ...grpc.CallOption) (*GenericResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GenericResponse)
...
func (c *authServiceClient) CandidateGoogleCallback(ctx context.Context, in *GoogleCallbackRequest, opts ...grpc.CallOption) (*TokenResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TokenResponse)
...
func (c *authServiceClient) CandidateUploadResume(ctx context.Context, in *UploadResumeRequest, opts ...grpc.CallOption) (*UploadResumeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *authServiceClient) EmployerSignup(ctx context.Context, in *EmployerSignupRequest, opts ...grpc.CallOption) (*GenericResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GenericResponse)
...
func (c *authServiceClient) EmployerLogin(ctx context.Context, in *EmployerLoginRequest, opts ...grpc.CallOption) (*TokenResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TokenResponse)
...
func (c *authServiceClient) EmployerVerifyEmail(ctx context.Context, in *EmployerVerifyEmailRequest, opts ...grpc.CallOption) (*TokenResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TokenResponse)
...
func (c *authServiceClient) EmployerGoogleLogin(ctx context.Context, in *GoogleLoginRequest, opts ...grpc.CallOption) (*GenericResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GenericResponse)
...
func (c *authServiceClient) EmployerGoogleCallback(ctx context.Context, in *GoogleCallbackRequest, opts ...grpc.CallOption) (*TokenResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TokenResponse)
...
type AuthServiceServer interface {
	// --- Candidate Public Routes ---
	CandidateSignup(context.Context, *CandidateSignupRequest) (*GenericResponse, error)
	CandidateLogin(context.Context, *CandidateLoginRequest) (*TokenResponse, error)
	CandidateVerifyEmail(context.Context, *CandidateVerifyEmailRequest) (*TokenResponse, error)
	...
	CandidateGoogleLogin(context.Context, *GoogleLoginRequest) (*GenericResponse, error)
	CandidateGoogleCallback(context.Context, *GoogleCallbackRequest) (*TokenResponse, error)
	// --- Candidate Protected Routes ---
	...
	CandidateUploadResume(context.Context, *UploadResumeRequest) (*UploadResumeResponse, error)
	// --- Employer Public Routes ---
	EmployerSignup(context.Context, *EmployerSignupRequest) (*GenericResponse, error)
	EmployerLogin(context.Context, *EmployerLoginRequest) (*TokenResponse, error)
	EmployerVerifyEmail(context.Context, *EmployerVerifyEmailRequest) (*TokenResponse, error)
	...
	EmployerGoogleLogin(context.Context, *GoogleLoginRequest) (*GenericResponse, error)
	EmployerGoogleCallback(context.Context, *GoogleCallbackRequest) (*TokenResponse, error)
	// --- Employer Protected Routes ---
...
func (UnimplementedAuthServiceServer) CandidateSignup(context.Context, *CandidateSignupRequest) (*GenericResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CandidateSignup not implemented")
}
func (UnimplementedAuthServiceServer) CandidateLogin(context.Context, *CandidateLoginRequest) (*TokenResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CandidateLogin not implemented")
}
func (UnimplementedAuthServiceServer) CandidateVerifyEmail(context.Context, *CandidateVerifyEmailRequest) (*TokenResponse, error) {
...
func (UnimplementedAuthServiceServer) CandidateGoogleLogin(context.Context, *GoogleLoginRequest) (*GenericResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CandidateGoogleLogin not implemented")
}
func (UnimplementedAuthServiceServer) CandidateGoogleCallback(context.Context, *GoogleCallbackRequest) (*TokenResponse, error) {
...
func (UnimplementedAuthServiceServer) CandidateUploadResume(context.Context, *UploadResumeRequest) (*UploadResumeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CandidateUploadResume not implemented")
}
func (UnimplementedAuthServiceServer) EmployerSignup(context.Context, *EmployerSignupRequest) (*GenericResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method EmployerSignup not implemented")
}
func (UnimplementedAuthServiceServer) EmployerLogin(context.Context, *EmployerLoginRequest) (*TokenResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method EmployerLogin not implemented")
}
func (UnimplementedAuthServiceServer) EmployerVerifyEmail(context.Context, *EmployerVerifyEmailRequest) (*TokenResponse, error) {
...
func (UnimplementedAuthServiceServer) EmployerGoogleLogin(context.Context, *GoogleLoginRequest) (*GenericResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method EmployerGoogleLogin not implemented")
}
func (UnimplementedAuthServiceServer) EmployerGoogleCallback(context.Context, *GoogleCallbackRequest) (*TokenResponse, error) {
...
func _AuthService_CandidateVerifyEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CandidateVerifyEmailRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).CandidateVerifyEmail(ctx, req.(*CandidateVerifyEmailRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AuthService_EmployerVerifyEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EmployerVerifyEmailRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).EmployerVerifyEmail(ctx, req.(*EmployerVerifyEmailRequest))
	}
	return interceptor(ctx, in, info, handler)
}
